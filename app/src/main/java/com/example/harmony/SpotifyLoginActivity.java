...
public class SpotifyLoginActivity extends AppCompatActivity {
    ...
    private static final String CLIENT_ID = "dc39aff95e79486db2b844b849371443";
    ...
    protected void handleAuthResponse(Intent intent) {
    ...
    protected void getCurrentPlayingTrack(String accessToken) {
        new Thread(() -> {
            try {
